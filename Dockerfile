...
#       In case ./target folder is somewhere else, then expected command line to build it from ./target location:
#       user@machine:~/targetDir$ docker build -f ../tomcat_web_app/Dockerfile . -t farrukhw/dice:ang_jsp
